...
// Handle status update only (also prevented if escalated)
...
<div class="sidebar" id="sidebar">
    <div class="sidebar-header">
        ...
        <div class="row-tagline">
            <span class="tagline">HOD Portal</span>
...
<div class="main-content">
    <div class="top-bar">
        <div class="welcome-message">Welcome, <span><?php echo htmlspecialchars($hod_name); ?></span><br><small style="font-size:0.8rem;"><?php echo htmlspecialchars($dept_name); ?></small></div>
    ...
    <div class="dashboard-body">
                ...
                <table class="complaints-table">
                    ...
                    <tbody>
                        <?php if (mysqli_num_rows($data_result) == 0): ?>
                            <tr><td colspan="8" style="text-align:center;">No complaints found. </div>--> </tr>
                        <?php else: ?>
        ...
        <?php elseif ($active_page == 'view-complaint' && $complaint_id): ?>
            ...
            if (!$complaint) {
                echo '<div class="alert error">Complaint not found or not assigned to you.</div>';
            } else {
        ...
        <?php elseif ($active_page == 'profile'): ?>
            ...
            <div class="content-area">
                ...
                <form method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group"><label>Full Name</label><input type="text" name="full_name" value="<?php echo htmlspecialchars($hod_name); ?>" required></div>
                    <div class="form-group"><label>Email (cannot be changed)</label><input type="email" value="<?php echo htmlspecialchars($hod_email); ?>" disabled></div>
