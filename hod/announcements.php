...
// Handle send announcement - Only to HOD's department
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['send_announcement'])) {
    ...
    if ($target_type === 'department') {
        $target_id = $hod_dept_id;
    } else {
        $target_id = null;
    }
    
    if (!in_array($target_type, ['all', 'students', 'staff', 'department'])) {
    ...
    if (empty($errors)) {
        ...
        mysqli_stmt_bind_param($insert_stmt, "sssiis", $title, $message, $target_type, $target_id, $hod_id, $expiry_date);
...
$users_sql = "SELECT id, full_name, email, role FROM users 
              WHERE role != 'admin' AND (department_id = ? OR role = 'student')
              ORDER BY full_name";
$users_stmt = mysqli_prepare($conn, $users_sql);
mysqli_stmt_bind_param($users_stmt, "i", $hod_dept_id);
...
mysqli_stmt_bind_param($sent_stmt, "i", $hod_id);
mysqli_stmt_execute($sent_stmt);
$sent_result = mysqli_stmt_get_result($sent_stmt);

// Get announcements received by HOD
...
mysqli_stmt_bind_param($received_stmt, "iii", $hod_id, $hod_dept_id, $hod_id);
...
<head>
    ...
    <title>Announcements - HOD Panel</title>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        @media (max-width: 768px) {
            ...
            .dept-info-box { flex-direction: column; align-items: flex-start; }
            .dept-info-box .lock-info { margin-left: 0; }
        ...
        @media (max-width: 480px) {
            ...
            .dept-badge { font-size: 0.6rem; padding: 2px 10px; }
...
<div class="sidebar" id="sidebar">
    ...
    <div class="sidebar-menu">
        <a href="hod_dashboard.php?page=dashboard" class="menu-item">
            <i class="fas fa-tachometer-alt"></i><span>Dashboard</span>
        </a>
        <a href="hod_dashboard.php?page=complaints" class="menu-item">
            <i class="fas fa-file-alt"></i><span>All Complaints</span>
        </a>
        <a href="hod_dashboard.php?page=pending" class="menu-item">
            <i class="fas fa-clock"></i><span>Pending</span>
        </a>
        <a href="hod_dashboard.php?page=resolved" class="menu-item">
            <i class="fas fa-check-circle"></i><span>Resolved</span>
        </a>
        <a href="hod_dashboard.php?page=escalated" class="menu-item">
            <i class="fas fa-exclamation-triangle"></i><span>Escalated</span>
        </a>
        <a href="announcements.php" class="menu-item active">
            <i class="fas fa-bullhorn"></i><span>Announcements</span>
        </a>
        <a href="hod_dashboard.php?page=profile" class="menu-item">
            <i class="fas fa-user-circle"></i><span>Profile</span>
        </a>
        <a href="hod_dashboard.php?page=change-password" class="menu-item">
...
<div class="main-content">
    ...
    <div class="top-bar">
        <div>
            ...
            <div style="font-size: 0.75rem; color: #6b85a0;"><?php echo htmlspecialchars($dept_name); ?> - HOD</div>
        </div>
        ...
        <div class="content-area">
            ...
            <div class="send-form-section">
                ...
                <div class="dept-info-box">
                    ...
                    <span style="color: #1f2c40; font-size: 0.85rem;">
                        <strong>Sending as HOD of:</strong>
                        <span class="dept-name"><?php echo htmlspecialchars($dept_name); ?></span>
                    </span>
                    <span class="lock-info">
                        <i class="fas fa-lock"></i> Can send to all or your department
                    </span>
                </div>
                    ...
                    <div class="form-row-3">
                        ...
                        <div class="form-group">
                            ...
                            <select name="target_type" required>
                                <option value="department" selected>🏛️ My Department</option>
                                <option value="students">🎓 Students Only</option>
                                <option value="staff">👔 Staff Only</option>
                                <option value="all">📢 Everyone</option>
                            </select>
                            <span class="form-hint"><i class="fas fa-info-circle"></i> "Students Only" sends to all students, "Staff Only" sends to all staff</span>
                        </div>
                    </div>
                    <div class="form-group">
