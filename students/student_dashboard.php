...
// Fetch all responses (including from deputy rector and rector)
...
if ($isResolved && !empty($complaint['updated_at'])) {
...
$slaStatus = ''; // 'active', 'overdue', 'resolved'
$overdueFormatted = '';
if ($isResolved) {
    $slaStatus = 'resolved';
} else {
...
<head>
    ...
    <style>
        /* ========== FULL CSS (same as previous versions) ========== */
        * {
            margin: 0;
            padding: 0;
        ...
        /* Sidebar (cobalt blue, collapsible) – same as student dashboard */
        .sidebar {
            width: 280px;
            background: #0047AB;
            color: white;
        ...
        .menu-item span { font-size: 0.95rem; transition: opacity 0.2s; }
        ...
        <div class="content-area">
            ...
            <div class="sla-card">
                ...
                <div class="sla-stats">
                    ...
                    <?php if ($isResolved && $resolutionFormatted): ?>
                        <div class="sla-item">
            ...
            <?php if ($complaint['status'] != 'closed' && $complaint['status'] != 'resolved'): ?>
                <div class="followup-section">
                    ...
                    <div id="followupAlert" class="followup-success" style="display:none;"></div>
...
<script>
    // Sidebar toggle (same as student dashboard)
    ...
    if (countdownElement && countdownElement.dataset.deadline) {
        ...
        function updateCountdown() {
            ...
            if (distance < 0) {
                // Deadline passed -> refresh page or show overdue message
    ...
    if (followupForm) {
        followupForm.addEventListener('submit', async function(e) {
            ...
            try {
                ...
                sendBtn.innerHTML = 'Send Follow‑up';
