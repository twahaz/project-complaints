...
<head>
    ...
    <title>Profile - Rector Panel</title>
...
<div class="main-content">
    ...
    <div class="dashboard-body">
        <div class="content-area">
            <h4><i class="fas fa-user-circle" style="color:#1a56db;"></i> My Profile</h4>
            ...
            <div class="profile-preview">
                ...
                <div class="info">
                    <h5><?php echo htmlspecialchars($rector_name); ?></h5>
                    <p><i class="fas fa-envelope" style="color:#1a56db; width:16px;"></i> <?php echo htmlspecialchars($rector_email); ?></p>
                    <p><i class="fas fa-phone" style="color:#1a56db; width:16px;"></i> <?php echo !empty($phone) ? htmlspecialchars($phone) : 'Not provided'; ?></p>
                    <p><i class="fas fa-user-tag" style="color:#1a56db; width:16px;"></i> Rector</p>
                </div>
            </div>
            ...
            <form method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="full_name" value="<?php echo htmlspecialchars($rector_name); ?>" required>
                </div>
                
                <div class="form-group">
                    <label>Email Address</label>
                    <input type="email" value="<?php echo htmlspecialchars($rector_email); ?>" disabled>
