...
<head>
    ...
    <style>
        /* ========== FULL CSS (identical to HOD/Dean dashboards) ========== */
        * {
            margin: 0;
            padding: 0;
...
<div class="main-content">
    <div class="top-bar">
        <div class="welcome-message">Welcome, <span><?php echo htmlspecialchars($officer_name); ?></span></div>
                ...
                <table class="complaints-table">
                    ...
                    <tbody>
                        <?php if (mysqli_num_rows($data_result) == 0): ?>
                            <tr><td colspan="8" style="text-align:center;">No complaints found. </div>--> </td>
                        <?php else: ?>
        ...
        <?php elseif ($active_page == 'profile'): ?>
            ...
            <div class="content-area">
                ...
                <form method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group"><label>Full Name</label><input type="text" name="full_name" value="<?php echo htmlspecialchars($officer_name); ?>" required></div>
                    <div class="form-group"><label>Email (cannot be changed)</label><input type="email" value="<?php echo htmlspecialchars($officer_email); ?>" disabled></div>
