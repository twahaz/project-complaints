...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['send_announcement'])) {
    ...
    if (empty($errors)) {
        ...
        mysqli_stmt_bind_param($insert_stmt, "sssiis", $title, $message, $target_type, $target_id, $it_officer_id, $expiry_date);
...
// Get announcements sent by IT Officer
...
mysqli_stmt_bind_param($sent_stmt, "i", $it_officer_id);
mysqli_stmt_execute($sent_stmt);
$sent_result = mysqli_stmt_get_result($sent_stmt);

// Get announcements received by IT Officer (from others)
...
mysqli_stmt_bind_param($received_stmt, "iii", $it_officer_id, $it_officer_id, $it_officer_id);
...
<head>
    ...
    <title>Announcements - IT Officer Panel</title>
...
<div class="sidebar" id="sidebar">
    ...
    <div class="sidebar-menu">
        <a href="it_officer_dashboard.php?page=dashboard" class="menu-item">
            <i class="fas fa-tachometer-alt"></i><span>Dashboard</span>
        </a>
        <a href="it_officer_dashboard.php?page=complaints" class="menu-item">
            <i class="fas fa-file-alt"></i><span>All Complaints</span>
        </a>
        <a href="it_officer_dashboard.php?page=pending" class="menu-item">
            <i class="fas fa-clock"></i><span>Pending</span>
        </a>
        <a href="it_officer_dashboard.php?page=resolved" class="menu-item">
            <i class="fas fa-check-circle"></i><span>Resolved</span>
        </a>
        <a href="it_officer_dashboard.php?page=escalated" class="menu-item">
            <i class="fas fa-exclamation-triangle"></i><span>Escalated</span>
        </a>
        <a href="announcements.php" class="menu-item active">
            <i class="fas fa-bullhorn"></i><span>Announcements</span>
        </a>
        <a href="it_officer_dashboard.php?page=profile" class="menu-item">
            <i class="fas fa-user-circle"></i><span>Profile</span>
        </a>
        <a href="it_officer_dashboard.php?page=change-password" class="menu-item">
...
<div class="main-content">
    ...
    <div class="top-bar">
        <div>
            ...
            <div style="font-size: 0.75rem; color: #6b85a0;">IT Officer</div>
        </div>
